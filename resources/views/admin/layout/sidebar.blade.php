<div class="sidebar pe-4 pb-3">
    ...
    <ul class="navbar-nav">
      ...
      <li><a href="{{ url('addblogpage') }}" class="nav-item nav-link "><i class="fa fa-envelope-open-text"></i>Add Blog</a></li>   
      <li><a href="{{ url('showblog') }}" class="nav-item nav-link "><i class="fa fa-keyboard me-2"></i>Show Blog</a> </li>          
      <li><a href="{{ url('addteam') }}" class="nav-item nav-link "><i class="fa fa-envelope-open-text"></i>Add Team</a> </li>          
